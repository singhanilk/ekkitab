...
class Ekkitab_Review_Model_Mysql4_Review_Product_Collection extends Ekkitab_Catalog_Model_Resource_Mysql4_Product_Collection
{
    ...
    protected function _joinFields()
    {
        ...
        $this->getSelect()
            ->join(array('rt' => $reviewTable),
                'rt.entity_pk_value = main_table.id',
    ...
    public function getSelectCountSql()
    {
        ...
        $sql = preg_replace('/^select\s+.+?\s+from\s+/is', 'select count(main_table.id) from ', $sql);
