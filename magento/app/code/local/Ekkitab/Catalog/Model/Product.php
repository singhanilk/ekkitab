 ...
 */
class Ekkitab_Catalog_Model_Product extends Mage_Catalog_Model_Product
{
    ...
    /**
     * Retrieve cost throught type instance
     *
     * @return unknown
     */
    ...
    /**
     * Retrieve TaxClassId throught type instance
     *
     * @return unknown
     */
    ...
    /**
     * Retrieve IsQtyDecimal throught type instance
     *
     * @return unknown
     */
...
//        $newProduct->setProductOptions($newOptionsArray);
    ...
    {
        return false; //$this->_isDuplicable;
    }
    ...
    {
        return false; //$this->getIsVirtual();
    }
