...
function endElement($parser, $name) {
	global $insideitem, $tag, $title, $description, $isbn13, $isbn10, $author, $weeksOnList, $thisWeek;
		if ($name == "BOOK") {
		echo $isbn13 . "\t" . $weeksOnList . "\t" . $thisWeek . "\n";
		$title = "";
		$description = "";
		$isbn10 = "";
		$isbn13 = "";
...
$fp = fopen("http://api.nytimes.com/svc/books/v2/lists.xml?list=paperback-Nonfiction&api-key=7445911964368f98ebf72c87c2d12913:19:60451432","rb")
