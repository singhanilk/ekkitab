...
ec2-run-instances ami-7d43ae14 -k ekkitab3  --availability-zone us-east-1d --group default --instance-type m1.large  -b /dev/sda1=:50 -b /dev/sdb=ephemeral0 -b /dev/sdc=ephemeral1 
