...
ec2-request-instances ami-dd967fb4 -k ekkitab3 --price 2.00 -type one-time --availability-zone us-east-1d --group default --instance-type m1.large  -b /dev/sda1=:50 -b /dev/sdc=ephemeral0 -b /dev/sdd=ephemeral1
