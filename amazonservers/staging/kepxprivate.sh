...
ec2-request-spot-instances ami-bdb65fd4 -k ekkitab3 --price 3.00 -type one-time --availability-zone us-east-1d --group default --instance-type m1.xlarge  -b /dev/sda1=:50 -b /dev/sdc=ephemeral0 -b /dev/sdd=ephemeral1
